...
| PR        | Wat                                                                                                                                                                                                                                                                            | ADR      |
| --------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | -------- |
| #PR       | Geen naam vooraf: de app opent op Vandaag met een kind zonder naam, en vraagt de naam na de eerste ronde (weg te klikken), op Jij, vóór de toets, bij een tweede kind en op de ouderpagina                                                                                     | 229      |
